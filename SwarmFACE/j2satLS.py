...
from SwarmFACE.plot_save.dual_sat_LS import *

def j2satLS(dtime_beg, dtime_end, sats, tshift=None, dt_along = 5, use_filter=True, \
...
#        tshift = find_tshift2sat_proxy(dtime_beg, sats, Rsph, AscLon)
    ...
    j_df = ls_dualJfac(dt, R, B, dB, dt_along=dt_along, er_db=er_db, 
    ...
    if savedata:
        save_dual_sat_LS(j_df, param)
    if saveplot:
        plot_dual_sat_LS(j_df, input_df, param)   
