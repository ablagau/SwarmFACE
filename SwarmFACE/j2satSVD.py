...
# -*- coding: utf-8 -*-
"""
Created on Tue Apr 26 19:03:27 2022
...
def j2satSVD(dtime_beg, dtime_end, sats, tshift=None, dt_along = 5, use_filter=True, \
            er_db=0.5, tauast= 0.13, taunul= 0.07, intpol='Linear', angTHR = 30., \
